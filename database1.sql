-- Smart Retail System - Simplified Database Schema
...
INSERT INTO products (product_name, description, short_description, price, compare_price, sku, stock_quantity, category_id, brand, is_featured) VALUES 
('iPhone 15 Pro', 'Latest Apple iPhone with advanced camera and A17 Pro chip', '6.1-inch Super Retina XDR display, Titanium design', 999.99, 1099.99, 'IP15P-256', 50, 2, 'Apple', 1),
('Samsung Galaxy S24', 'AI-powered smartphone with advanced features', '6.2-inch Dynamic AMOLED, Snapdragon 8 Gen 3', 849.99, 899.99, 'SGS24-256', 75, 2, 'Samsung', 1),
('MacBook Pro 16"', 'Professional laptop with M3 Max chip', '16-inch Liquid Retina XDR display, 32GB RAM', 2499.99, 2799.99, 'MBP16-M3', 25, 3, 'Apple', 1),
('Dell XPS 15', 'Powerful Windows laptop for professionals', '15.6-inch OLED display, Intel Core i9', 1899.99, 1999.99, 'DXPS15-1T', 30, 3, 'Dell', 0),
('Wireless Headphones', 'Noise-cancelling wireless headphones with premium sound', '30-hour battery life, comfortable over-ear design', 199.99, 249.99, 'WH-1000XM4', 100, 1, 'Sony', 1),
('Smart Watch Series 8', 'Advanced smartwatch with health monitoring', 'Always-on display, GPS, heart rate monitor', 399.99, 429.99, 'SW-S8-44', 60, 1, 'Apple', 1);
